...
def get_all_activities():
    """The overall activity list on homepage"""
...
def remove_activity(activity_id, coach_id):
    ...
    db.session.execute(sql, {"activity_id": activity_id, "coach_id": coach_id})
    db.session.commit()
    return True

def join_activity(activity_id, trainee_id):
    """Trainee take part in course."""
...
def get_participation(activity_id):
    ...
    sql = text("""SELECT u.id,u.name, p.completed, p.joined_at,
...
def mark_as_completed(activity_id, trainee_id):
    """Trainee log their progress after participation."""
...
def add_review(activity_id, trainee_id, stars, comment):
    """Trainee can only add review after participation."""
...
def add_feedback(activity_id, coach_id, trainee_id, feedback):
    """Coach can add feedback to their own trainees."""
...
def get_my_feedback(activity_id, trainee_id):
    """Trainee view feedback on the course page. """
...
def check_participation(activity_id, trainee_id):
    """Verify function fot ensuring participation"""
