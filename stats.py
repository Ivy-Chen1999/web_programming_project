...
def get_trainee_stats(trainee_id):
    ...
    summary_sql = text("""SELECT COUNT(*) AS total_courses,
    ...
    details_sql = text("""SELECT a.name AS activity_name, p.completed
                          FROM participation p
...
def get_coach_stats(coach_id):
    ...
    sql = text("""SELECT a.id AS activity_id, a.name AS activity_name,
